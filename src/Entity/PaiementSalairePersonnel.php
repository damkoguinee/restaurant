...
class PaiementSalairePersonnel
{
    ...
    #[ORM\ManyToOne(inversedBy: 'paimentSalairePersonnels')]
    ...
    #[ORM\OneToMany(targetEntity: MouvementCaisse::class, mappedBy: 'paiementSalaire', orphanRemoval:true, cascade:['persist', 'remove'])]
