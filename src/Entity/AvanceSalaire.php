...
class AvanceSalaire
{
    ...
    #[ORM\OneToMany(targetEntity: MouvementCaisse::class, mappedBy: 'avanceSalaire', orphanRemoval:true, cascade:['persist', 'remove'])]
    private Collection $mouvementCaisses;

    #[ORM\OneToMany(targetEntity: MouvementCollaborateur::class, mappedBy: 'avanceSalaire' , orphanRemoval:true, cascade:['persist', 'remove'])]
