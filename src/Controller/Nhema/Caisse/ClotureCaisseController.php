...
#[Route('/nhema/caisse/cloture/caisse')]
class ClotureCaisseController extends AbstractController
{
    #[Route('/', name: 'app_nhema_caisse_cloture_caisse_index', methods: ['GET'])]
    public function index(ClotureCaisseRepository $clotureCaisseRepository): Response
    {
        return $this->render('nhema/caisse/cloture_caisse/index.html.twig', [
            'cloture_caisses' => $clotureCaisseRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_nhema_caisse_cloture_caisse_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_nhema_caisse_cloture_caisse_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('nhema/caisse/cloture_caisse/new.html.twig', [
            'cloture_caisse' => $clotureCaisse,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_nhema_caisse_cloture_caisse_show', methods: ['GET'])]
    public function show(ClotureCaisse $clotureCaisse): Response
    {
        return $this->render('nhema/caisse/cloture_caisse/show.html.twig', [
            'cloture_caisse' => $clotureCaisse,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_nhema_caisse_cloture_caisse_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, ClotureCaisse $clotureCaisse, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('nhema/caisse/cloture_caisse/edit.html.twig', [
            'cloture_caisse' => $clotureCaisse,
            'form' => $form,
        ]);
    }

    #[Route('/delete/{id}', name: 'app_nhema_caisse_cloture_caisse_delete', methods: ['POST'])]
    public function delete(Request $request, ClotureCaisse $clotureCaisse, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->redirectToRoute('app_nhema_caisse_cloture', ['lieu_vente' => $clotureCaisse->getLieuVente()->getId()], Response::HTTP_SEE_OTHER);
    }
}
