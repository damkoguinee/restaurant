...
#[Route('/nhema/personnel/paiement/salaire/personnel')]
class PaiementSalairePersonnelController extends AbstractController
{
    #[Route('/accueil/{lieu_vente}', name: 'app_nhema_personnel_paiement_salaire_personnel_index', methods: ['GET'])]
    ...
    {
        return $this->render('nhema/personnel/paiement_salaire_personnel/index.html.twig', [
    ...
    #[Route('/new/{lieu_vente}', name: 'app_nhema_personnel_paiement_salaire_personnel_new', methods: ['GET', 'POST'])]
    public function new(Request $request, UserRepository $userRep, AbsencePersonnelRepository $absencesRep, PrimePersonnelRepository $primesRep, AvanceSalaireRepository $avanceRep, CaisseRepository $caisseRep, ModePaiementRepository $modePaieRep, DeviseRepository $deviseRep, CategorieOperationRepository $catOpRep, CompteOperationRepository $compteOpRep, PersonnelRepository $personnelRep, MouvementCaisseRepository $mouvementRep, EntityManagerInterface $entityManager, LieuxVentes $lieu_vente, EntrepriseRepository $entrepriseRep): Response
    {
        if ($request->get("periode")) {
            ...
            if ($request->get("compte") && $request->get("modePaie")) {
                ...
                if ($solde_caisse >= $salaireNet) {
                    ...
                    return new RedirectResponse($this->generateUrl('app_nhema_personnel_paiement_salaire_personnel_new', ['lieu_vente' => $lieu_vente->getId(), 'periode' => $request->get("periode")]));
                }else{
        ...
        // dd($paiementsInfos);
        return $this->render('nhema/personnel/paiement_salaire_personnel/new.html.twig', [
    ...
    #[Route('/show/{id}/{lieu_vente}', name: 'app_nhema_personnel_paiement_salaires_personnel_show', methods: ['GET'])]
    ...
    {
        return $this->render('nhema/personnel/paiement_salaire_personnel/show.html.twig', [
    ...
    public function edit(Request $request, PaiementSalairePersonnel $paiementSalairePersonnel, EntityManagerInterface $entityManager, LieuxVentes $lieu_vente, EntrepriseRepository $entrepriseRep): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_nhema_personnel_paiement_salaires_personnel_index', ['lieu_vente' => $lieu_vente->getId()], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('delete/{id}/{lieu_vente}', name: 'app_nhema_personnel_paiement_salaire_personnel_delete', methods: ['POST' , 'GET'])]
    public function delete(Request $request, PaiementSalairePersonnel $paiementSalairePersonnel, EntityManagerInterface $entityManager, LieuxVentes $lieu_vente, EntrepriseRepository $entrepriseRep): Response
    {
        ...
        return $this->redirectToRoute('app_nhema_personnel_paiement_salaire_personnel_index', ['lieu_vente' => $lieu_vente->getId()], Response::HTTP_SEE_OTHER);
    }


    #[Route('/pdf/fichepaie/{id}/{lieu_vente}', name: 'app_nhema_personnel_paiement_salaire_personnel_fiche_paie', methods: ['GET'])]
    public function genererPdfAction(PaiementSalairePersonnel $paiementSalaire, LieuxVentes $lieu_vente, PersonnelRepository $personnelRep, EntrepriseRepository $entrepriseRep, LieuxVentesRepository $lieuVenteRep)
    {
        ...
        $html = $this->renderView('nhema/personnel/paiement_salaire_personnel/fiche_paie.html.twig', [
