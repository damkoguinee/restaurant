...
#[Route('/nhema/stock/liste/inventaire')]
class ListeInventaireController extends AbstractController
{
    // #[Route('/', name: 'app_nhema_stock_liste_inventaire_index', methods: ['GET', 'POST'])]
    // public function index(ListeInventaireRepository $listeInventaireRepository, EntrepriseRepository $entrepriseRep): Response
    // {  
    //     return $this->render('nhema/stock/liste_inventaire/index.html.twig', [
    //         'liste_inventaires' => $listeInventaireRepository->findAll(),
    //         'entreprise' => $entrepriseRep->find(1),
    //     ]);
    // }

    // #[Route('/new/{lieu_vente}', name: 'app_nhema_stock_liste_inventaire_new', methods: ['GET', 'POST'])]
    ...
    //         return new RedirectResponse($this->generateUrl('app_nhema_stock_liste_inventaire_new', ['lieu_vente' => $lieu_vente->getId()]));
    //     }
    ...
    // #[Route('/{id}', name: 'app_nhema_stock_liste_inventaire_show', methods: ['GET'])]
    // public function show(ListeInventaire $listeInventaire, EntrepriseRepository $entrepriseRep): Response
    // {
    //     return $this->render('nhema/stock/liste_inventaire/show.html.twig', [
    //         'liste_inventaire' => $listeInventaire,
    //         'entreprise' => $entrepriseRep->find(1),
    ...
    // #[Route('/{id}/edit', name: 'app_nhema_stock_liste_inventaire_edit', methods: ['GET', 'POST'])]
    ...
    //         return $this->redirectToRoute('app_nhema_stock_liste_inventaire_index', [], Response::HTTP_SEE_OTHER);
    //     }

    //     return $this->render('nhema/stock/liste_inventaire/edit.html.twig', [
    //         'liste_inventaire' => $listeInventaire,
    //         'form' => $form,
    //         'entreprise' => $entrepriseRep->find(1),
    //         'lieu_vente' => $listeInventaire->getLieuVente(),
    ...
    // #[Route('/delete/{id}', name: 'app_nhema_stock_liste_inventaire_delete', methods: ['POST', 'GET'])]
    ...
    //     return $this->redirectToRoute('app_nhema_stock_liste_inventaire_new', ['lieu_vente' => $listeInventaire->getLieuVente()->getId()], Response::HTTP_SEE_OTHER);
    // }

    // #[Route('/inventaire/{id}', name: 'app_nhema_stock_inventaire_index', methods: ['GET', 'POST'])]
    ...
    //             $stockProduct->setQuantite($qtite_stock_init + (-$inventaire->getQuantiteInv()));
    ...
    //             // return new RedirectResponse($this->generateUrl('app_nhema_stock_inventaire_index', ['id' => $listeInventaire->getId()]));
    //         }
    ...
    //             $mouvementProduct = $mouvementProductRep->findOneBy(['inventaire' => $inventaire]);
    ...
    //         $inventaire = new Inventaire();
    //         return new RedirectResponse($this->generateUrl('app_nhema_stock_inventaire_index', ['id' => $listeInventaire->getId(), 'search' => $request->get("search"), 'magasin' => $request->get("magasin"), 'pageEncours' => $request->get('pageEncours', 1)]));            
    //     }
    ...
    //     return $this->render('nhema/stock/inventaire/index.html.twig', [
    //         'entreprise' => $entrepriseRep->find(1),
    //         'lieu_vente' => $listeInventaire->getLieuVente(),
    ...
    // #[Route('/cloturess/{id}', name: 'app_nhema_stock_liste_inventaire_cloture', methods: ['POST', 'GET'])]
