...
#[Route('/nhema/stock/anomalie/produit')]
class AnomalieProduitController extends AbstractController
{
    // #[Route('/', name: 'app_nhema_stock_anomalie_produit_index', methods: ['GET'])]
    // public function index(AnomalieProduitRepository $anomalieProduitRepository): Response
    // {
    //     return $this->render('nhema/stock/anomalie_produit/index.html.twig', [
    //         'anomalie_produits' => $anomalieProduitRepository->findAll(),
    //     ]);
    // }

    // #[Route('/new/{lieu_vente}', name: 'app_nhema_stock_anomalie_produit_new', methods: ['GET', 'POST'])]
    ...
    //         return $this->redirectToRoute('app_nhema_stock_anomalie_produit_index', [], Response::HTTP_SEE_OTHER);
    //     }
    //     return $this->render('nhema/stock/anomalie_produit/new.html.twig', [
    ...
    // #[Route('/{id}', name: 'app_nhema_stock_anomalie_produit_show', methods: ['GET'])]
    // public function show(AnomalieProduit $anomalieProduit, EntrepriseRepository $entrepriseRep): Response
    // {
    //     return $this->render('nhema/stock/anomalie_produit/show.html.twig', [
    //         'anomalie_produit' => $anomalieProduit,
    //         'entreprise' => $entrepriseRep->find(1),
    ...
    // #[Route('/{id}/edit', name: 'app_nhema_stock_anomalie_produit_edit', methods: ['GET', 'POST'])]
    ...
    //     return $this->render('nhema/stock/anomalie_produit/edit.html.twig', [
    //         'anomalie_produit' => $anomalieProduit,
    //         'form' => $form,
    //     ]);
    // }

    // #[Route('/delete/{id}', name: 'app_nhema_stock_anomalie_produit_delete', methods: ['POST', 'GET'])]
    ...
    //         return $this->redirectToRoute('app_nhema_stock_gestion_stock_show', ['stock' => $stock->getId()], Response::HTTP_SEE_OTHER);
    //     }

    //     return $this->redirectToRoute('app_nhema_stock_anomalie_produit_new', ['lieu_vente' => $anomalieProduit->getStock()->getLieuVente()->getId()], Response::HTTP_SEE_OTHER);
    // }
}
