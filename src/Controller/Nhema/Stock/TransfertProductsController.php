...
#[Route('/nhema/stock/transfert/products')]
class TransfertProductsController extends AbstractController
{
    // #[Route('/index/{lieu_vente}', name: 'app_nhema_stock_transfert_products_index')]
    ...
    //     return $this->render('nhema/stock/transfert_products/index.html.twig', [
    ...
    // #[Route('/new/{lieu_vente}', name: 'app_nhema_stock_transfert_products_new')]
    ...
    //         return $this->redirectToRoute('app_nhema_stock_transfert_products_index', ['lieu_vente' => $lieu_vente->getId()], Response::HTTP_SEE_OTHER);

    //     }

    //     return $this->render('nhema/stock/transfert_products/new.html.twig', [
    //         'entreprise' => $entrepriseRep->find(1),
    //         'lieu_vente' => $lieu_vente,
    //         'transfert' => $transfert,
    //         'form'      => $form
    ...
    // #[Route('/show/{id}/{lieu_vente}', name: 'app_nhema_stock_transfert_products_show', methods: ['GET'])]
    ...
    //     return $this->render('nhema/stock/transfert_products/show.html.twig', [
    //         'entreprise' => $entrepriseRep->find(1),
    //         'lieu_vente' => $lieu_vente,
    ...
    // #[Route('/edit/{id}/{lieu_vente}', name: 'app_nhema_stock_transfert_products_edit', methods: ['POST', 'GET'])]
    ...
    //     return $this->render('nhema/stock/transfert_products/edit.html.twig', [
    //         'entreprise' => $entrepriseRep->find(1),
    //         'lieu_vente' => $lieu_vente,
    //         'transfert_product' => $transfert,
    //         'form'      => $form
    ...
    // #[Route('/delete/{id}/{lieu_vente}', name: 'app_nhema_stock_transfert_products_delete', methods: ['POST'])]
    ...
    // #[Route('/transfert/{id}/{lieu_vente}', name: 'app_nhema_stock_transfert_products')]
    ...
    //             $em->flush();                
    //         }
    //         return new RedirectResponse($this->generateUrl('app_nhema_stock_transfert_products', ['id' => $transfertProduct->getId(), 'lieu_vente' => $lieu_vente->getId(), 'search' => $request->get("search"), 'magasin' => $request->get("magasin"), 'pageEncours' => $request->get('pageEncours', 1)])); 
    //     }
    ...
    //     return $this->render('nhema/stock/transfert_products/transfert.html.twig', [
    //         'entreprise' => $entrepriseRep->find(1),
    //         'lieu_vente' => $lieu_vente,
    //         'search' => $search,
