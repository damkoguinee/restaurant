...
#[Route('/nhema/stock/liste/transfert/product')]
class ListeTransfertProductController extends AbstractController
{
    #[Route('/index/{lieu_vente}', name: 'app_nhema_stock_Liste_transfert_products_index')]
    public function transfertIndex(LieuxVentes $lieu_vente, Request $request, ListeStockRepository $listeStockRep, EntrepriseRepository $entrepriseRep, TransfertProductsRepository $transfertRepo): Response
    {
        ...
        return $this->render('nhema/stock/liste_transfert_product/index.html.twig', [
    ...
    #[Route('/transfert/{id}/{lieu_vente}', name: 'app_nhema_stock_liste_transfert_products_reception')]
    public function transfert(TransfertProducts $transfertProduct, LieuxVentes $lieu_vente,  Request $request, StockRepository $stockRep, ListeTransfertProductRepository $listeTransfertRep, ListeStockRepository $listeStockRep, MouvementProductRepository $mouvementRep, EntrepriseRepository $entrepriseRep, EntityManagerInterface $em): Response
    {
        ...
        if ($request->get("reception") and $request->get("id_liste_transfert") and $request->get("quantite") > 0){
            ...
            return new RedirectResponse($this->generateUrl('app_nhema_stock_liste_transfert_products_reception', ['id' => $transfertProduct->getId(), 'lieu_vente' => $lieu_vente->getId()])); 
        }
        ...
        return $this->render('nhema/stock/liste_transfert_product/reception.html.twig', [
            'entreprise' => $entrepriseRep->find(1),
            'lieu_vente' => $lieu_vente,
    ...
    #[Route('/delete/transfert/{id}', name: 'app_nhema_stock_liste_transfert_product_delete', methods: ['POST', 'GET'])]
    public function delete(Request $request, ListeTransfertProduct $transfertProduct, StockRepository $stockRep, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->redirectToRoute('app_nhema_stock_transfert_products', ['id' => $transfertProduct->getTransfert()->getId(), 'lieu_vente' => $transfertProduct->getStockDepart()->getLieuVente()->getId()], Response::HTTP_SEE_OTHER);
    }

    #[Route('/delete/reception/{id}/{lieu_vente}', name: 'app_nhema_stock_liste_transfert_product_delete_reception', methods: ['POST', 'GET'])]
    public function deleteReception(Request $request, MouvementProduct $mouvementProduct, LieuxVentes $lieu_vente, StockRepository $stockRep, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->redirectToRoute('app_nhema_stock_transfert_products_show', ['id' => $transfert_product->getId(), 'lieu_vente' => $lieu_vente->getId(), 'position' => 'reception'], Response::HTTP_SEE_OTHER);
    }
}
