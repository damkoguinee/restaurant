...
namespace App\Controller\Nhema\Entrees;
...
#[Route('/nhema/entrees/versement')]
class VersementController extends AbstractController
{
    #[Route('/accueil/{lieu_vente}', name: 'app_nhema_entrees_versement_index', methods: ['GET'])]
    public function index(VersementRepository $versementRepository, UserRepository $userRep, Request $request, LieuxVentes $lieu_vente, EntrepriseRepository $entrepriseRep): Response
    {
        ...
        return $this->render('nhema/entrees/versement/index.html.twig', [
    ...
    #[Route('/new/{lieu_vente}', name: 'app_nhema_entrees_versement_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager, LieuxVentes $lieu_vente, VersementRepository $versementRep, CompteOperationRepository $compteOpRep, CategorieOperationRepository $catetgorieOpRep, DeviseRepository $deviseRep, MouvementCollaborateurRepository $mouvementCollabRep, UserRepository $userRep, EntrepriseRepository $entrepriseRep): Response
    {
        ...
        $form = $this->createForm(VersementType::class, $versement, ['lieu_vente' => $lieu_vente]);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_nhema_entrees_versement_index', ['lieu_vente' => $lieu_vente->getId()], Response::HTTP_SEE_OTHER);
        }
        ...
        return $this->render('nhema/entrees/versement/new.html.twig', [
            'versement' => $versement,
            'form' => $form,
            'entreprise' => $entrepriseRep->find(1),
            'lieu_vente' => $lieu_vente,
    ...
    #[Route('/show/{id}/{lieu_vente}', name: 'app_nhema_entrees_versement_show', methods: ['GET'])]
    public function show(Versement $versement, ModificationRepository $modificationRep, LieuxVentes $lieu_vente, EntrepriseRepository $entrepriseRep): Response
    {
        ...
        return $this->render('nhema/entrees/versement/show.html.twig', [
            'versement' => $versement,
            'entreprise' => $entrepriseRep->find(1),
            'lieu_vente' => $lieu_vente,
    ...
    #[Route('/edit/{id}/{lieu_vente}', name: 'app_nhema_entrees_versement_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Versement $versement, VersementRepository $versementRep, EntityManagerInterface $entityManager, UserRepository $userRep, MouvementCollaborateurRepository $mouvementCollabRep, MouvementCaisseRepository $mouvementCaisseRep, LieuxVentes $lieu_vente, EntrepriseRepository $entrepriseRep): Response
    {
        ...
        return $this->render('nhema/entrees/versement/edit.html.twig', [
            'versement' => $versement,
            'form' => $form,
            'entreprise' => $entrepriseRep->find(1),
            'lieu_vente' => $lieu_vente,
    ...
    #[Route('/delete/{id}/{lieu_vente}', name: 'app_nhema_entrees_versement_delete', methods: ['POST'])]
    ...
    #[Route('/pdf/reçu/{id}/{lieu_vente}', name: 'app_nhema_entrees_versement_recu_pdf', methods: ['GET'])]
    public function recuPdf(Versement $versement, LieuxVentes $lieu_vente, MouvementCollaborateurRepository $mouvementCollabRep, EntrepriseRepository $entrepriseRep, LieuxVentesRepository $lieuVenteRep)
    {
        ...
        $html = $this->renderView('nhema/entrees/versement/recu_pdf.html.twig', [
            'versement' => $versement,
