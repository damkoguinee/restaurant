...
#[Route('/nhema/entrees/recette')]
class RecetteController extends AbstractController
{
    #[Route('/accueil/{lieu_vente}', name: 'app_nhema_entrees_recette_index', methods: ['GET'])]
    public function index(RecetteRepository $recetteRepository, Request $request, LieuxVentes $lieu_vente, EntrepriseRepository $entrepriseRep): Response
    {
        ...
        return $this->render('nhema/entrees/recette/index.html.twig', [
            'recettes' => $recettes,
    ...
    #[Route('/new/{lieu_vente}', name: 'app_nhema_entrees_recette_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager, CompteOperationRepository $compteOpRep, CategorieOperationRepository $catetgorieOpRep, LieuxVentes $lieu_vente, EntrepriseRepository $entrepriseRep): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_nhema_entrees_recette_index', ['lieu_vente' => $lieu_vente->getId()], Response::HTTP_SEE_OTHER);
        }

        return $this->render('nhema/entrees/recette/new.html.twig', [
            'recette' => $recette,
            'form' => $form,
            'entreprise' => $entrepriseRep->find(1),
            'lieu_vente' => $lieu_vente,
    ...
    #[Route('/show/{id}/{lieu_vente}', name: 'app_nhema_entrees_recette_show', methods: ['GET'])]
    public function show(Recette $recette, LieuxVentes $lieu_vente, EntrepriseRepository $entrepriseRep): Response
    {
        return $this->render('nhema/entrees/recette/show.html.twig', [
            'recette' => $recette,
            'entreprise' => $entrepriseRep->find(1),
            'lieu_vente' => $lieu_vente,
        ]);
    ...
    #[Route('/edit/{id}/{lieu_vente}', name: 'app_nhema_entrees_recette_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Recette $recette, MouvementCaisseRepository $mouvementCaisseRep, EntityManagerInterface $entityManager, LieuxVentes $lieu_vente, EntrepriseRepository $entrepriseRep): Response
    {
        ...
        return $this->render('nhema/entrees/recette/edit.html.twig', [
            'recette' => $recette,
            'form' => $form,
            'entreprise' => $entrepriseRep->find(1),
            'lieu_vente' => $lieu_vente,
    ...
    #[Route('/delete/{id}/{lieu_vente}', name: 'app_nhema_entrees_recette_delete', methods: ['POST'])]
