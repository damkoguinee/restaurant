...
class PersonnelController extends AbstractController
{
    ...
    public function index(PersonnelRepository $personnelRepository, EntrepriseRepository $entrepriseRep): Response
    {
    ...
    public function show(Personnel $personnel, EntrepriseRepository $entrepriseRep): Response
    {
