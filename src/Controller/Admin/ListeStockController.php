...
class ListeStockController extends AbstractController
{
    ...
    public function new(Request $request, ProductRepository $productRep,  EntrepriseRepository $entrepriseRep, EntityManagerInterface $entityManager): Response
    {
